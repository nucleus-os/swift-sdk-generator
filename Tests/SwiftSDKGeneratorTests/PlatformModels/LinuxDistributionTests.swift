...
struct LinuxDistributionTests {
    struct UbuntuTests {
        @Test(arguments: [
            ...
            ("26.04.1", LinuxDistribution.Ubuntu.resolute),
            ("resolute", LinuxDistribution.Ubuntu.resolute),
        ])
        func validVersionStrings(versionString: String, expectedVersion: LinuxDistribution.Ubuntu)
            throws
        {
        ...
        @Test(arguments: [
            ...
            (LinuxDistribution.Ubuntu.resolute, "26.04.1"),
        ])
        ...
        func requiredPackages(ubuntuVersion: LinuxDistribution.Ubuntu) {
            ...
            #expect(
                requiredPackages.contains(where: { $0.matches(regex: "libstdc\\+\\+-\\d{2}-dev") }))
        }
    }
    ...
    struct DebianTests {
        ...
        func validVersionStrings(versionString: String, expectedVersion: LinuxDistribution.Debian)
            throws
        {
